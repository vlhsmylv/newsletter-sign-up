...
const Success = ({ email }) => {
  return (
    <div className="lg:h-min h-screen flex flex-col lg:justify-start justify-center gap-5 bg-white lg:shadow-xl max-w-[400px] lg:px-12 lg:py-8 p-0 lg:rounded-[30px] rounded-none">
